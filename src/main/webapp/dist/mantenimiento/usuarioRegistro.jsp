		...
		<div class="navbar-wrapper  ">
			<div class="navbar-content scroll-div ">
				...
				<ul class="nav pcoded-inner-navbar ">
					<li class="nav-item pcoded-menu-caption"><label>Navegación</label>
					</li>
					...
					<li class="nav-item pcoded-hasmenu"><a href="#"
						class="nav-link "><span class="pcoded-micon"><i
								class="feather icon-layout"></i></span><span class="pcoded-mtext">Mantenimiento</span></a>
					...
					<li class="nav-item pcoded-menu-caption"><label>Forms
							&amp; table</label></li>
					...
					<li class="nav-item"><a href="tbl_bootstrap.html"
						class="nav-link "><span class="pcoded-micon"><i
							...
							class="pcoded-mtext">Bootstrap table</span></a></li>
	...
	<header
		...
		<div class="m-header">
			...
			<a href="#!" class="b-brand"> <!-- ========   change your logo hear   ============ -->
				...
				src="assets/images/logo-icon.png" alt="" class="logo-thumb">
				...
				<div class="page-block">
					<div class="row align-items-center">
						<div class="col-md-12">
							...
							<ul class="breadcrumb">
								<li class="breadcrumb-item"><a href="/softech_web"><i
										class="feather icon-home"></i></a></li>
								<li class="breadcrumb-item"><a href="/softech_web/usuario">
										usuarios</a></li>
				...
				<div class="col-sm-12">
					<div class="card">
						...
						<div class="card-body">
							...
							<form action="usuarioRegistro" method="POST">
								<input type="hidden" name="txtId" class="form-control"
									value="${usuario.id_usuario}" id="" placeholder="">

								<div class="form-row">
									<div class="form-group col-md-6">
										<label for="">Nombre de Usuario</label> <input type="text"
											class="form-control" name="txtUsuario"
											value="${usuario.nombre_usuario}" id="" placeholder="">
									</div>
									<div class="form-group col-md-6">
										<label for="inputPassword4">Contraseña</label> <input
											type="password" class="form-control" name="txtContrasena"
											value="${usuario.contrasena}" id="inputPassword4"
											placeholder="">
									</div>
								</div>
								<div class="form-row">
									<div class="form-group col-md-6">
										<label for="inputAddress">Nombres</label> <input type="text"
											class="form-control" name="txtNombres"
											value="${usuario.nombres}" id="inputAddress" placeholder="">
									</div>
									<div class="form-group col-md-6">
										<label for="inputAddress2">Apellidos</label> <input
											type="text" class="form-control" name="txtApellidos"
											value="${usuario.apellidos}" id="inputAddress2"
											placeholder="">
									</div>
								</div>
								<div class="form-row">
